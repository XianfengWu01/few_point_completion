...
# from dataset import CRNShapeNet
...
def train(params):
    ...
    train_dataset = ShapeNet('/home/featurize/data/PCN', 'train', params.category)
    val_dataset = ShapeNet('/home/featurize/data/PCN', 'valid', params.category)
    # train_dataset = CRNShapeNet('/home/featurize/data/our_data', 'train')
    # val_dataset = CRNShapeNet('/home/featurize/data/PCN', 'valid')
    ...
    for epoch in range(1, params.epochs + 1):
        ...
        if total_cd_l1 < best_cd_l1:
            ...
            torch.save({
                ...
                'state_dict_coarse': model.Decoder.mlp.state_dict(),
                # 'state_dict_sa':,
                # '':,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='Transformer_point', help='Tag of experiment')
    ...
    parser.add_argument('--epochs', type=int, default=250, help='Epochs of training')
