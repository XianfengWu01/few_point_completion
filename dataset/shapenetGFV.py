...
class ShapeNetGFV(data.Dataset):
    ...
    def _load_data(self):
        ...
        for line in lines:
            ...
            if self.split == 'train':
                partial_paths.append(os.path.join(self.dataroot, 'partial', category, model_id + '_{}.npy'))
            else:
                partial_paths.append(os.path.join(self.dataroot, 'partial', category, model_id + '.npy'))
            complete_paths.append(os.path.join(self.dataroot, 'complete', category, model_id + '.npy'))
